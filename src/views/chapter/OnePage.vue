<template>
  <div>
    ...
    <one-page-menu :next-page="nextPage" :prev-page="prePage"> </one-page-menu>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    documentMousemove(event) {
      if (
        window.outerWidth > (5 * event.screenX) / 2 ||
