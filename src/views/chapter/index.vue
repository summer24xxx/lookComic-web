  ...
  <div id="chapter">
    ...
    <div v-if="chapter">
      <template v-if="header">
        <div class="header mb-4 text-center mt-4" id="page-header">
          <h2>
            <router-link
                ...
                class="muted-link"
            >{{ chapter.comic.title }}</router-link
            >
        ...
        <div class="form-check text-center">
          <input
              ...
              type="checkbox"
          />
          <label class="form-check-label" for="read-style"> 下拉式阅读 </label>
        </div>
      </template>
      ...
      <transition name="fade" mode="out-in">
        <component
            :is="dropdown ? 'dropdown' : 'one-page'"
            :current-page="currentPage"
            @update-page="updatePage"
            :key="dropdown ? 'dropdown' : 'one-page'"
        ></component>
      </transition>
      ...
      <div @mouseleave="menuMouseleave" id="menu">
        <div class="text-center btn-group" id="menu-content" role="group">
          <template v-if="prevChapter || nextChapter">
            <button
                v-if="prevChapter"
                @click="prevChapterEvent(currentPage)"
                class="btn btn-outline-light"
                data-original-title="上一章"
                data-placement="left"
                data-toggle="tooltip"
                type="button"
            >
            ...
            <button
                v-if="nextChapter"
                @click="nextChapterEvent(currentPage)"
                class="btn btn-outline-light"
                data-original-title="下一章"
                data-placement="left"
                data-toggle="tooltip"
                type="button"
            >
          ...
          >
            ...
            >
              <path
                  d="M343.312 374.256v-16a16 16 0 0 1 16-16h23.648a16 16 0 0 1 16 16v16a16 16 0 0 1-16 16h-23.648a16 16 0 0 1-16-16z m100.16 0v-16a16 16 0 0 1 16-16H650.08a16 16 0 0 1 16 16v16a16 16 0 0 1-16 16H459.472a16 16 0 0 1-16-16z m-100.16 144.704v-16a16 16 0 0 1 16-16h23.648a16 16 0 0 1 16 16v16a16 16 0 0 1-16 16h-23.648a16 16 0 0 1-16-16z m100.16 0v-16a16 16 0 0 1 16-16H650.08a16 16 0 0 1 16 16v16a16 16 0 0 1-16 16H459.472a16 16 0 0 1-16-16z m-100.16 144.688v-16a16 16 0 0 1 16-16h23.648a16 16 0 0 1 16 16v16a16 16 0 0 1-16 16h-23.648a16 16 0 0 1-16-16z m100.16 0v-16a16 16 0 0 1 16-16H650.08a16 16 0 0 1 16 16v16a16 16 0 0 1-16 16H459.472a16 16 0 0 1-16-16zM256 240v541.92h497.392V240H256z m529.392 589.92H224a16 16 0 0 1-16-16V208a16 16 0 0 1 16-16h561.392a16 16 0 0 1 16 16v605.92a16 16 0 0 1-16 16z"
                  p-id="2870"
              ></path>
            </svg>
          </button>
        ...
        <img
            @mouseenter="menuIconMouseenter"
            alt=""
            id="menu-icon"
            src="/api/cover/list-unordered.svg"
        />
      </div>
    </div>
  </div>
...
export default {
  ...
  computed: {
    ...mapGetters(["chapter", "prevChapter", "nextChapter", "currentPage"]),
