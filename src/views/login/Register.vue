      ...
      >
        ...
        <div class="row mb-2">
          ...
          <input
            ...
            required
            type="text"
            v-model.lazy="email.value"
          />
          <div
            :class="email.feedbackClass()"
            class="col align-self-center text-left"
          >
            {{ email.feedback }}
          </div>
        ...
        <div class="row mb-2">
          ...
          <input
            :class="repeatPass.inputClass()"
            :pattern="repeatPass.pattern"
            @change="checkRepeatPass"
            class="form-control col-4"
            id="repeat-password"
            placeholder="重复密码"
            required
            type="password"
            v-model="repeatPass.value"
          />
          <div
            :class="repeatPass.feedbackClass()"
            class="col align-self-center text-left"
          >
            {{ repeatPass.feedback }}
          </div>
        ...
        <div class="row">
          ...
          <button
            ...
            class="btn btn-lg btn-primary btn-block col-2"
            type="submit"
          >
            注册
          </button>
        ...
        <div class="row mt-4">
          ...
          <span class="col text-right"
            >已有账号？<router-link to="/login">登录</router-link></span
          >
          <div class="col-4"></div>
        </div>
  ...
  methods: {
    checkUsername(event) {
      ...
      if (this.username.isValid) {
        hasUsername(this.username.value)
          .then((exist) => {
            if (exist) {
